...
const projects: Project[] = [
  {
    ...
    description:
      "Simulation system using ROS 2 for autonomous humanoid robot behavior testing and control.",
    ...
    links: [
      {
        url: "https://github.com/Gladiatos-Programming/Simulasi-Gazebo-Darnet",
        label: "GitHub",
        kind: "github",
      },
    ],
  },
  {
    ...
    title: "Medicine App",
    description:
      "Flutter mobile app to help users find nearby pharmacies and medicines.",
    tech: ["Flutter", "JavaScript", "Python", "Django"],
    image: "/project/project_sobat.webp",
    featured: false,
    year: "2024",
    links: [
      {
        url: "https://github.com/PBP24-D10/sobat_mobile",
        label: "GitHub",
        kind: "github",
      },
    ],
  },
  {
    ...
    image: "/project/project_gemastik.webp",
    featured: false,
    year: "Jun–Sept 2025",
    links: [
      {
        url: "https://github.com/orgs/PACILGEMAS/repositories",
        label: "GitHub",
        kind: "github",
      },
    ],
  },
  {
    ...
    image: "/project/project_carlok.webp",
    objectClass: "object-contain p-4",
    featured: true,
    year: "2026",
    links: [
      { url: "https://siruang.cs.ui.ac.id/", label: "SiRuang", kind: "demo" },
      { url: "https://carlok.cs.ui.ac.id/", label: "CARLOK", kind: "demo" },
    ],
  },
  {
    id: "05",
    title: "Ruang Terang",
    description:
      "Website for a non-profit focused on skill development and charity events.",
    tech: ["Next.js", "PostgreSQL", "Google Analytics"],
    image: "/project/ruang-terang.webp",
    featured: true,
    year: "2026",
    links: [
      { url: "https://ruang-terang.com/", label: "Live Demo", kind: "demo" },
    ],
  },
];
...
const FeaturedCard = ({
  ...
  <article
    data-reveal="up"
    className={`reveal-delay-${index + 1} flex flex-col group border rounded-2xl overflow-hidden`}
    style={BORDER}
  >
    {/* Image on top */}
    <div
      className="aspect-[16/10] relative p-4"
      style={{ backgroundColor: "#0d1913" }}
    >
    ...
    <div className="flex flex-col gap-5 p-8 flex-1">
      ...
      <div className="flex flex-wrap gap-2 pt-1">
        {project.tech.map((tag) => (
          <span
            key={tag}
            className="font-label-md text-caption px-2.5 py-1 border text-on-surface-variant"
            style={BORDER}
          >
            {tag}
          </span>
      ...
      <div
        className="flex flex-wrap gap-3 pt-4 mt-auto border-t"
        style={BORDER}
      >
...
const TableRow = ({
  ...
  <div
    data-reveal="up"
    className={`reveal-delay-${index + 1} grid grid-cols-[2rem_1fr_auto] md:grid-cols-[2rem_1fr_1fr_auto] gap-4 md:gap-8 items-center px-6 py-5 border-b group hover:bg-[#5cff95]/[0.03] transition-colors duration-200 cursor-default`}
    style={BORDER}
  >
    {/* # */}
    <span className="font-label-md text-label-md text-[#5cff95] uppercase tracking-widest">
    ...
    <>
      <section className="w-full border-t" style={BORDER}>
        <div className="py-section-gap md:py-section-gap-desktop px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
          <div data-reveal="up" className="mb-20">
        ...
        <div className="py-section-gap md:py-section-gap-desktop px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto">
          ...
          <div className="border rounded-xl overflow-hidden" style={BORDER}>
            ...
            >
              ...
              <span className="hidden md:block font-label-md text-label-md text-on-surface-variant uppercase tracking-widest">
                Stack
              </span>
              <span className="font-label-md text-label-md text-on-surface-variant uppercase tracking-widest text-right">
                Links
              </span>
            </div>

            {projects.map((project, index) => (
              <TableRow key={project.id} project={project} index={index} />
            ))}
          </div>
        </div>
      </section>
